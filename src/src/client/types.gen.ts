...
export type ValuesGetResponse = (Array<(string)>);

export type ValuesGetError = unknown;

export type ValuesPostData = {
    body?: string;
};

export type ValuesPostResponse = (unknown);

export type ValuesPostError = unknown;

export type ValuesGet1Data = {
    path: {
        id: number;
    };
};

export type ValuesGet1Response = (string);

export type ValuesGet1Error = unknown;

export type ValuesPutData = {
    body?: string;
    path: {
        id: number;
    };
...
export type ValuesPutResponse = (unknown);

export type ValuesPutError = unknown;

export type ValuesDeleteData = {
    path: {
        id: number;
    };
};

export type ValuesDeleteResponse = (unknown);

export type ValuesDeleteError = unknown;